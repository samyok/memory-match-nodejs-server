...
const APP_NAME = "Memory Match";
const startTime = Date();

// Require Winston with custom settings for logger
...
// set up restart code, something I would be able to access.
...
var place = function() {};
place.prototype.clean = function () {
 ...
 * @param {object} haystack the haystack the needle is in
 */
